            ...
            <div className="flex items-center gap-2">
              <div className="w-16 h-2 bg-neutral-600 rounded-full overflow-hidden">
                <motion.div
                  ...
                  initial={{ width: '0%' }}
                  animate={{ width: `${isActive ? Math.min(speed * 0.8, 95) : 25}%` }}
                />
              </div>
              <span className="text-neutral-400 text-xs w-8">
                {isActive ? Math.min(Math.round(speed * 0.8), 95) : 25}%
              </span>
            </div>
          </div>
            ...
            <div className="flex items-center gap-2">
              <div className="w-16 h-2 bg-neutral-600 rounded-full overflow-hidden">
                <motion.div
                  ...
                  initial={{ width: '35%' }}
                  animate={{ width: `${isActive ? Math.min(35 + speed * 0.4, 75) : 35}%` }}
                />
              </div>
              <span className="text-neutral-400 text-xs w-12">
                {(isActive ? (35 + speed * 0.4) / 10 : 3.5).toFixed(1)}GB
              </span>
            </div>
          </div>
            ...
            <div className="flex items-center gap-2">
              <div className="w-16 h-2 bg-neutral-600 rounded-full overflow-hidden">
                <motion.div
                  ...
                  initial={{ width: '15%' }}
                  animate={{ width: `${isActive ? Math.min(15 + speed * 0.6, 85) : 15}%` }}
                />
              </div>
              <span className="text-neutral-400 text-xs w-12">
                {isActive ? Math.min(Math.round(speed * 0.6), 85) : 15}%
              </span>
            </div>
          </div>
