...
const COMPRESSION_PROFILES = {
  lightning: { 
    ...
    desc: 'Maximum speed, minimal compression'
  },
  balanced: { 
    name: 'Balanced', 
    level: 9, 
    ...
    desc: 'Optimal speed/ratio balance'
  },
  maximum: { 
    name: 'Maximum', 
    level: 18, 
  ...
  secure: { 
    ...
    desc: 'Encrypted with strong compression'
  }
};
...
export default function ControlDashboard({ settings, onSettingsChange, disabled }) {
  ...
  const handleProfileChange = (profile) => {
    ...
    updateSetting('compressionLevel', COMPRESSION_PROFILES[profile].level);
    if (profile === 'secure') {
